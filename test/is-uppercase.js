...
describe('is-uppercase', function() {
    ...
    it('should return true if the string have uppercases and others characters but lowercases', function() {
        'HELLO, 0'.isUppercase().should.equal(true);
    });

    it('should return fasle if the string do not have any uppercases', function() {
    ...
    it('should return false if the string have uppercases and lowercases', function() {
        'Hello'.isUppercase().should.equal(false);
    });
});