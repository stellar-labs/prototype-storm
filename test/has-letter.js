...
describe('has-letter', function() {
    ...
    it('should return true if the string only has lowercases', function() {
        'hello'.hasLetter().should.equal(true);
    });

    it('should return true if the string only has uppercases', function() {
        'HELLO'.hasLetter().should.equal(true);
    });

    it('should return true if the string has spaces and lowercases', function() {
        'hello world'.hasLetter().should.equal(true);
    });

    it('should return true if the string has uppercases and spaces', function() {
        'HELLO WORLD'.hasLetter().should.equal(true);
    });

    it('should return true if the string has different kind of characters, including letters', function() {
