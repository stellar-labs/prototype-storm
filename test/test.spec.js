 ...
 */
var r=n(41);t.use=function(e){return~o.indexOf(e)||(e(t,r),o.push(e)),t},
/*!
 * Utility Functions
 */
t.util=r;
 ...
 */
t.overwriteChainableMethod=n(28),
/*!
 * Compare by inspect method
 */
t.compareByInspect=n(27),
/*!
 ...
 */
t.getOwnEnumerableProperties=n(26),
/*!
 ...
 * isNaN method
 */
t.isNaN=n(24)},function(e,t,n){e.exports=n(3)},function(e,t,n){"use strict";var o=n(42);n(18),n(17),n(16),n(15),describe("Prototype Storm",function(){describe("Flatten",function(){it("Should return a flattened array",function(){(0,o.expect)([1,[2,[3]]].flatten()).to.deep.equal([1,2,3])}),it("Should return the same array",function(){(0,o.expect)([1,2,3].flatten()).to.deep.equal([1,2,3])}),it("Should return an empty array",function(){(0,o.expect)([].flatten()).to.deep.equal([])})}),describe("Map",function(){it("Should return the values of the object",function(){(0,o.expect)({a:1,b:2,c:3}.map(function(e){return e})).to.deep.equal([1,2,3])}),it("Should return the indexes of the object",function(){(0,o.expect)({a:1,b:2,c:3}.map(function(e,t){return t})).to.deep.equal(["a","b","c"])})}),describe("Average",function(){it("Should return the average of an array",function(){(0,o.expect)([1,2,3].average()).to.equal(6)})}),describe("Empty",function(){it("Should return true on empty object",function(){(0,o.expect)({}.empty()).to.deep.equal(!0)}),it("Should return false on non-empty object",function(){(0,o.expect)({a:1}.empty()).to.deep.equal(!1)}),it("Should return true on empty array",function(){(0,o.expect)([].empty()).to.deep.equal(!0)}),it("Should return false on non-empty array",function(){(0,o.expect)([1].empty()).to.deep.equal(!1)}),it("Should return true on empty string",function(){(0,o.expect)("".empty()).to.deep.equal(!0)}),it("Should return false on non-empty string",function(){(0,o.expect)("Testing Baby".empty()).to.deep.equal(!1)}),it("Should return true on zero number",function(){(0,o.expect)((0).empty()).to.deep.equal(!0)}),it("Should return false on non-zero number",function(){(0,o.expect)(123..empty()).to.deep.equal(!1)})})})}]);