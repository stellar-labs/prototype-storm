...
- Array
  - [Using `Array.average`](#using-arrayaverage)
...
```javascript
var array1 = [1, 2, 3, 4];
var array2 = ['hello', 'world', {name: 'John'}];
var array3 = [1, Infinity, 2, 3];
var array4 = [];

console.log( array1.average() );
console.log( array2.average() );
console.log( array3.average() );
console.log( array4.average() );
```
